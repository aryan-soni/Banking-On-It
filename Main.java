...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        ImageIcon icon = new ImageIcon("./imgs/bank.png"); // image for first dialog
    ...
    public static void customer(String names[], String phoneNums[], String addresses[], String accountKeys[], double balances[], Font defaultFont) throws IOException {
        ...
        ImageIcon icon = new ImageIcon("./imgs/customer.png"); // image for initial customer dialog
    ...
    public static void admin(String names[], String phoneNums[], String addresses[], String accountKeys[], double balances[], Font defaultFont) throws IOException {
        String password = Admin.collectPass(defaultFont); // call method from .BankingOnIt.Admin class that collects the admin password
        ...
        // else - the password is correct
            ...
            // call method from .BankingOnIt.Admin class that orchestrates the admin controls
    ...
    public static void help(Font defaultFont) {
        // set up image
        ImageIcon icon = new ImageIcon("./imgs/help.png");
    ...
    public static void exit(Font defaultFont) {
        // set up image
        ImageIcon icon = new ImageIcon("./imgs/thanks.png");
